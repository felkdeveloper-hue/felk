  ...
  return (
    <section aria-labelledby="product-reviews" className="mt-16 space-y-8 border-t pt-12">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <h2 id="product-reviews" className="font-display text-2xl font-bold uppercase">
            Product Reviews
          </h2>
          <p className="text-muted-foreground mt-1 text-sm">
            Verified buyers who received their order can leave a review.
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.2fr)]">
        <div className="space-y-4">
          <div className="flex items-end gap-3">
            <p className="font-display text-5xl font-bold leading-none">{stats.average || '—'}</p>
            <div className="pb-1">
        ...
        <div className="space-y-4">
          ...
          {!isAuthed ? (
            ...
            <form onSubmit={onSubmit} className="space-y-4 rounded-2xl border p-5">
              ...
              <Button type="submit" disabled={createMutation.isPending || body.trim().length < 10}>
