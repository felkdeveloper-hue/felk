...
export function DeliveryTrustCue({ className, variant = 'pdp' }: DeliveryTrustCueProps) {
  ...
  return (
    <p
      className={cn(
        'inline-flex items-center gap-2 text-[12px] font-medium tracking-wide sm:text-[13px]',
        className,
      )}
      style={{ color: '#EAB308' }}
    >
      ...
      <span>
        <span className="font-bold text-black">Guarantee</span> delivered within or before 4 days
      </span>
    </p>
  );
}
