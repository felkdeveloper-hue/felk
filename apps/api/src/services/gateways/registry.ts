import { PAYMENT_METHOD, type PaymentMethod } from '@/constants/payment-status.js';
import type { PaymentGateway } from '@/services/interfaces/payment-gateway.service.js';
import { payHereGateway } from '@/services/gateways/payhere.gateway.js';
import { kokoGateway } from '@/services/gateways/koko.gateway.js';
import { mintpayGateway } from '@/services/gateways/mintpay.gateway.js';
import { codGateway } from '@/services/gateways/cod.gateway.js';
