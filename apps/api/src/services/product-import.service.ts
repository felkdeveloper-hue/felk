...
export const IMPORT_COLUMNS: ColumnDef[] = [
  ...
  },
  {
    ...
    example: 'No refunds. Exchanges available; customer covers exchange shipping costs.',
  },
  {
    key: 'warranty',
    label: 'Warranty',
...
export class ProductImportService {
  ...
  async buildTemplate(): Promise<Buffer> {
    ...
    sheet.addRow({
      ...
      returns: 'yes',
      returnPolicy: 'No refunds. Exchanges available; customer covers exchange shipping costs.',
      warranty: 'no',
      warrantyDetails: '',
      paymentMethod: 'both',
  ...
  buildCsvTemplate(): string {
    ...
    const row1Values: Record<string, string | number> = {
      ...
      Returns: 'yes',
      'Return Policy': 'No refunds. Exchanges available; customer covers exchange shipping costs.',
      Warranty: 'no',
      'Warranty Details': '',
      'Payment Method': 'both',
      Images: sampleImage1,
